...
for i=1:n_stns
    ...
    fns_plot.plt_ff_svrlstns(f_inpt_V, ff_Vamp_mat,bf_nm_v,123,...
        stn,r,date, time,vlbl_vect,{'Frequency,~Hz'},'initial',evnt,x_lim,y_lim,FACTR_freq)
    if stn=="UH1"
...
%         stn,r,date, time,albl_vect,{'f (Hz)'},'initial',evnt,x_lim,y_lim,FACTR_freq)
% end
% Time domain
...
%         stn,r,date, time,ulbl_vect,{'t (s)'},'initial',evnt,x_lim,y_lim)
% end